        ...
        <>
            ...
            <Stack display={'flex'} flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'} width={'100%'} px={1.5} pt={1} backgroundColor={theme.palette.background.paper} position={'sticky'} top={0} zIndex={1000}>
                ...
                <Stack direction={'row'} spacing={1}>
                    ...
                    <Link to={'/'}>
                        <img src={ItolsLogo} width={50} alt='LogoItols' />
...
// const Header = () => {
//     const theme = useTheme();
//     const navContainerRef = useRef(null); // Reference for the navigation bar
//     const { toggleTheme, isDarkMode } = useThemeMode();
//     const menuItems = PublicMenu();

//     useEffect(() => {
//         // Apply GSAP animations on scroll
//         gsap.fromTo(
...
//         <>
//             <Stack
//                 ref={navContainerRef} // Reference for GSAP
//                 display={'flex'}
//                 flexDirection={'row'}
...
//                                 }}
//                                 fontSize={13}
//                                 color={x.link === window.location.pathname ? theme.palette.text.disabled : theme.palette.text.primary}
//                             >
//                                 {x.title}
//                             </Typography>
//                         </Link>
